                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('staff.register') }}">
                        ...
                        <div class="form-group row mb-2">
                            <label for="userid" class="col-md-4 col-form-label text-md-right">{{ __('User Name') }}</label>
                            <div class="col-md-6">
                                <input id="userid" type="text" class="form-control @error('username') is-invalid @enderror" name="username" value="{{ old('username') }}" required autofocus>
                                @error('username')
                        ...
                        <div class="form-group row mb-2">
                            <label for="servicegroup" class="col-md-4 col-form-label text-md-right">{{ __('Service Group') }}</label>
                            <div class="col-md-6">
                                <select id="servicegroup" class="form-control @error('servicegroup') is-invalid @enderror" name="servicegroup" required>
